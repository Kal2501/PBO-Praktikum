...
class Mobil {
    ...
    public static void tambahMobil(String merk, String nama, String mesin, long harga, int jenisBahanBakar) {
        Mobil mobilBaru;
    ...
    public static void updateDataMobil(int nomor, String merk, String nama, String mesin, long harga,
            int jenisBahanBakar) {
        Mobil mobilBaru;
        switch (jenisBahanBakar) {
            case 2:
